...
(* OASIS_START *)
(* DO NOT EDIT (digest: f8822d6f04b22899d85e5d53193cdc44) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/prepor/ocaml-parser";
          synopsis = "EDN parser";
          description = Some [OASISText.Para "EDN parser"];
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\131SQ\\\012j\212\014\007\218\231D\1633R\221";
     oasis_exec = None;
